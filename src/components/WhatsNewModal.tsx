import { Sparkles, X, ArrowRight, MoveVertical, MoveHorizontal, LayoutTemplate, LucideIcon } from 'lucide-react';
...
const WhatsNewModal: React.FC<WhatsNewModalProps> = ({ isOpen, onClose }) => {
    ...
    const features: FeatureItem[] = [
        ...
        },
        {
            ...
            bg: 'bg-purple-500/10',
            title: t('whats_new.f3_title'),
            desc: t('whats_new.f3_desc')
        },
    ];
